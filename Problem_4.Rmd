...
## c) Central Air Installation Decision

Let's test the marginal effect of CentralAir using both models.
We'll take an average counterfactual approach:
- Pick homes in the test set that currently have no A/C
- Predict their value as-is
- Predict again after switching CentralAir = "Y"
